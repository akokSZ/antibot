...
- Яндекс Метрика для сайта с передачей IP и FingerPrint
- Для совместимости с некоторыми CMS добавлен механизм AWSESSION (аналог SESSION)
- Доб. возможность создавать другие конфиг файлы .ini

### Changed
- Ускорен процесс измерения FPS, оптимизация
- csrf стал недоступен по API
- Уменьшено количество запросов xhr.php

### Fixed
- Незначительное исправление интерфейса
- Исправлена ошибка IFrame cross domain:
